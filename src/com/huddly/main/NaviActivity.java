...
import com.huddly.main.NaviActivity.TabFactory;
...
public class NaviActivity extends FragmentActivity implements
	...
	private void initialiseTabHost(Bundle args) {
		...
		addTab(R.string.lbl_search, R.drawable.ic_action_search,
				SearchFragmentActivity.class, args);
		addTab(R.string.lbl_attending, R.drawable.ic_navigation_menu,
				AttendingFragmentActivity.class, args);

		// Default to first tab
		mTabHost.setCurrentTabByTag("tab" + R.string.lbl_search);
		this.onTabChanged("tab" + R.string.lbl_search);
